      ...
      <main className="flex min-h-screen items-center justify-center bg-black p-6 text-white">
        <section className="rounded-3xl border border-red-500/40 bg-red-500/10 p-8">
          ...
          <p className="mt-2 text-red-300">
            Could not load course data. Please check Supabase connection.
          </p>
        </section>
      </main>
    );
        ...
        <section className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:col-span-3">
          <BentoCard className="md:col-span-2">
            ...
            <p className="mt-4 max-w-2xl text-zinc-400">
              Track your courses, progress, streaks, and weekly learning momentum in one premium dashboard.
            </p>
          ...
          {courses?.map((course) => (
            <BentoCard key={course.id}>
              ...
              <p className="text-sm text-zinc-500">Active Course</p>
          ...
          <BentoCard className="md:col-span-2">
            ...
            <div className="mt-8 flex h-44 items-end gap-3">
              {[80, 120, 60, 150, 90, 115, 70].map((height, index) => (
                <div
                  key={index}
                  style={{ height }}
